...
botao0.addEventListener("click", () => {
  if (objPergunta.correta == 0) { mostrarAcerto() 
  } else {
    mostrarErrou()
  }
})
...
botao1.addEventListener("click", () => {
  if (objPergunta.correta == 1) { mostrarAcerto() 
  } else {
    mostrarErrou()
  }
})
...
botao2.addEventListener("click", () => {
  if (objPergunta.correta == 2) { mostrarAcerto() 
  } else {
    mostrarErrou()
  }
})
...
botao3.addEventListener("click", () => {
  if (objPergunta.correta == 3) { mostrarAcerto() 
  } else {
    mostrarErrou()
  }
})
